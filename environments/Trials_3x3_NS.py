...
class TrialEnv(MiniGridEnv):
    ...
    def _gen_grid(self, width, height):
        ...
        if self.cue:
            ...
            # elif self.task_id in [0, 3, 4, 7]:
            #     if self.use_lava:
            #         self.grid_data[12] = 90  # lava value
            #         # self.grid_data[30] = 90
            #     if self.use_ball:
            #         self.grid_data[14] = 30  # ball value
    ...
    def extractState(self):
        ...
        if self.partial:
            ...
            if self.agent_pos[1] == 4 and self.agent_pos[0] == 4:
                ...
                # self.put_obj(DisappearCue(), 3, 3)
                # self.put_obj(DisappearCue(), 5, 3)
        ...
        # state = np.append(state, agent_dir)
        # state = state[9:45]
        ...
        # partial_view_size = self.agent_view_size
        # l0 = current_agent_pos - 20
        # l1 = current_agent_pos - 9
        # l2 = current_agent_pos
        # l3 = current_agent_pos + 9
        # l4 = current_agent_pos + 18
        # l5 = current_agent_pos + 27
        # l6 = current_agent_pos + 36
        # # print(state)
        # if agent_dir == 1:  # down
        #     part_state[0:5] = state[
        #         current_agent_pos - 2 : current_agent_pos - 2 + partial_view_size
        #     ]
        #     part_state[5:10] = state[l3 - 2 : l3 - 2 + partial_view_size]
        #     part_state[10:15] = state[l4 - 2 : l4 - 2 + partial_view_size]
        #     part_state[15:20] = state[l5 - 2 : l5 - 2 + partial_view_size]
        #     part_state[20:25] = state[l6 - 2 : l6 - 2 + partial_view_size]
        # elif agent_dir == 4:  # right
        #     part_state[0:5] = state[l1 : l1 + partial_view_size + 1]
        #     part_state[5:10] = state[l3 - 2 : l3 - 2 + partial_view_size]
        #     part_state[10:15] = state[l4 - 2 : l4 - 2 + partial_view_size]
        #     part_state[15:20] = state[l5 - 2 : l5 - 2 + partial_view_size]
        #     part_state[20:25] = state[l6 - 2 : l6 - 2 + partial_view_size]
